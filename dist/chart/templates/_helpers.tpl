...
*/}}
{{- define "metal-credential-sync.name" -}}
...
*/}}
{{- define "metal-credential-sync.fullname" -}}
...
*/}}
{{- define "metal-credential-sync.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "metal-credential-sync.resourceName" -}}
{{- $fullname := include "metal-credential-sync.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "metal-credential-sync.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enable | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "metal-credential-sync.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
