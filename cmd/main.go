...
import (
	...
	"github.com/ironcore-dev/metal-credential-sync/internal/controller"
	"github.com/ironcore-dev/metal-credential-sync/internal/metrics"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "bd36b7a2.metal.ironcore.dev",
	...
	if err = (&controller.BMCSecretReconciler{
		...
		Recorder:       mgr.GetEventRecorderFor("metal-credential-sync-bmcsecret"),
	...
	if err = (&controller.SecretBackendConfigReconciler{
		Client:         mgr.GetClient(),
		Scheme:         mgr.GetScheme(),
		Recorder:       mgr.GetEventRecorderFor("metal-credential-sync-backendconfig"),
		BackendFactory: backendFactory,
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SecretBackendConfig")
		os.Exit(1)
	}
